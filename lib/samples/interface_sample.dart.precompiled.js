...
// Native classes
// Method closures
$$.BoundClosure$1 = [X, {"": "BoundClosure;_self,__js_helper$_target,_receiver,__js_helper$_name",
...
$$.BoundClosure$10 = [X, {"": "BoundClosure;_self,__js_helper$_target,_receiver,__js_helper$_name",
  call$1: function(p0) {
    return this.__js_helper$_target.call(this._self, p0);
  },
  $is_args1: true
...
Controller: {"": "EventDispatcher;_listener,frameHistory,_latestFrame,connection,_isConnected,_isGesturesEnabled,_listeners",
  ...
  Controller$1$host: function(host) {
    ...
    t1 = new W._EventStream(this.connection, C.EventStreamProvider_open._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Controller_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = new W._EventStream(this.connection, C.EventStreamProvider_close._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.Controller_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = new W._EventStream(this.connection, C.EventStreamProvider_message._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Controller_closure1(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  static: {
...
Controller_closure0: {"": "Closure;this_1",
  call$1: function($event) {
    ...
    t1._listener.onDisconnect$1(t1);
  },
  $is_args1: true
},
...
Controller_closure1: {"": "Closure;this_2",
  call$1: function($event) {
    ...
    t6._listener.onFrame$2(t6, t6._latestFrame);
  },
  $is_args1: true
},
...
DefaultListener: {"": "EventDispatcher;_listeners",
  onConnect$1: function(controller) {
    var t1 = new X.LeapEvent(null, null, null);
    t1._type = $.LeapEvent_LEAPMOTION_CONNECTED;
    t1._LeapMotionDart$_target = this;
    t1.frame = null;
    controller.dispatchEvent$1(controller, t1);
  },
  onDisconnect$1: function(controller) {
    var t1 = new X.LeapEvent(null, null, null);
    t1._type = $.LeapEvent_LEAPMOTION_DISCONNECTED;
    t1._LeapMotionDart$_target = this;
    t1.frame = null;
    controller.dispatchEvent$1(controller, t1);
  },
  onFrame$2: function(controller, frame) {
    var t1 = new X.LeapEvent(null, null, null);
    t1._type = $.LeapEvent_LEAPMOTION_FRAME;
    t1._LeapMotionDart$_target = this;
    t1.frame = frame;
    controller.dispatchEvent$1(controller, t1);
  },
  onInit$1: function(controller) {
    var t1 = new X.LeapEvent(null, null, null);
    t1._type = $.LeapEvent_LEAPMOTION_INIT;
    t1._LeapMotionDart$_target = this;
    t1.frame = null;
    controller.dispatchEvent$1(controller, t1);
  }
...
EventDispatcher: {"": "Object;",
  dispatchEvent$1: function(_, $event) {
    var t1, i, t2;
    for (t1 = this._listeners, i = 0; false; ++i) {
      if (i >= 0)
        throw H.ioore(t1, i);
      t2 = t1[i];
      t2.get$type(t2);
...
KeyTapGesture: {"": "Gesture;direction,pointable?,position,progress,duration,durationSeconds,frame,hands,id,pointables,state,type", static: {
...
ScreenTapGesture: {"": "Gesture;direction,pointable?,position,progress,duration,durationSeconds,frame,hands,id,pointables,state,type", static: {
"": "ScreenTapGesture_classType",
}
},

SwipeGesture: {"": "Gesture;direction,pointable?,position,speed,startPosition,duration,durationSeconds,frame,hands,id,pointables,state,type", static: {
...
Vector3: {"": "Object;x>,y>,z>",
  ...
  $eq: function(_, other) {
    ...
    return !J.$eq(this.x, t1.get$x(other)) || !J.$eq(this.y, t1.get$y(other)) || !J.$eq(this.z, t1.get$z(other));
  },
  isValid$0: function() {
    var t1, t2;
    t1 = this.x;
...
Interceptor: {"": "Object;",
  ...
  "%": "ArrayBuffer|Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
},
...
["", "interface_sample.dart", , B, {
main: function() {
  document.querySelector("#text").textContent = "Initializing...";
  var interfaceSample = new B.InterfaceSample(null, new P.Stopwatch(null, null), 0);
  interfaceSample.controller = X.Controller$(null);
  interfaceSample.controller._listener = interfaceSample;
},
...
InterfaceSample: {"": "Object;controller,watch,framesNumber",
  ...
  onDisconnect$1: function(controller) {
    document.querySelector("#text").textContent = "onDisconnect";
  },
  onFrame$2: function(controller, frame) {
    var t1;
    this.framesNumber = this.framesNumber + 1;
    t1 = this.watch;
    if (C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000, 1000000) > 1000) {
      document.querySelector("#text").textContent = "Data FPS: " + C.JSNumber_methods.toString$0(this.framesNumber / (C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000, 1000000) / 1000) * 10 / 10);
      this.framesNumber = 0;
      t1.stop$0(t1);
      t1.reset$0(t1);
      t1.start$0(t1);
...
function dart_precompiled($collectedClasses) {
  ...
  function InterfaceSample(controller, watch, framesNumber) {
    this.controller = controller;
    this.watch = watch;
    this.framesNumber = framesNumber;
  }
  InterfaceSample.builtin$cls = "InterfaceSample";
  if (!"name" in InterfaceSample)
    InterfaceSample.name = "InterfaceSample";
  $desc = $collectedClasses.InterfaceSample;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InterfaceSample.prototype = $desc;
