...
// Bound closures
$$.Bound_frame_Controller = {"": "BoundClosure;_self,_target,_receiver",
...
Controller: {"": "EventDispatcher;_listener<,frameHistory<,_latestFrame@,connection<,_isConnected?,_isGesturesEnabled,_heartBeatTimer@,_listeners",
  frame$1$history: function($history) {
    ...
    if (typeof $history !== "number")
      return this.frame$1$history$bailout(1, $history);
  ...
  frame$1$history$bailout: function(state0, $history) {
    var t1, t2;
    t1 = this.frameHistory;
    t2 = t1.length;
    if ($.$ge$n($history, t2))
...
EventDispatcher: {"": "Object;",
  hasEventListener$2: function(type, listener) {
    var t1, t2, i, exists, t3;
    for (t1 = this._listeners, t2 = t1.length, i = 0; exists = false, i < t2; ++i) {
      t3 = t1[i];
      if ($.get$type$x(t3) === type) {
        t3 = t3.get$listener();
        t3 = t3.$eq(t3, listener);
      } else
        t3 = false;
      if (t3) {
        exists = true;
  ...
  addEventListener$2: function(typeStr, listenerFunction) {
    if (this.hasEventListener$2(typeStr, listenerFunction))
      return;
    this._listeners.push($.ListenerObject$(typeStr, listenerFunction));
  },
  dispatchEvent$1: function(_, $event) {
    var i, t1;
    for (i = 0; t1 = this._listeners, i < t1.length; ++i) {
      t1 = t1[i];
      if ($.get$type$x(t1) === $event._type)
        t1.listener$1($event);
    }
  },
...
ListenerObject: {"": "Object;type>,listener<",
  ...
  ListenerObject$2: function(typeStr, listenerFunction) {
    this.type = typeStr;
...
Frame: {"": "Object;currentFramesPerSecond,fingersVector<,handsVector,pointablesVector,gesturesVector,id<,interactionBox,timestamp<,toolsVector<,rotation,scaleFactorNumber,translationVector,controller",
  ...
  get$hands: function() {
    return this.handsVector;
  },
  get$fingers: function() {
    return this.fingersVector;
  },
  get$tools: function() {
    return this.toolsVector;
  },
  ...
  $eq: function(_, other) {
    if (other == null)
      return false;
    if (!$.$eq(this.id, other.get$id()) || !this.isValid$0() || other.isValid$0())
      return false;
    return true;
  },
  isValid$0: function() {
...
Gesture: {"": "Object;duration,durationSeconds,frame<,hands,id<,pointables<,state,type>",
  $eq: function(_, other) {
    if (other == null)
      return false;
    return $.$eq(this.id, other.get$id()) && true;
  },
  isValid$0: function() {
...
InteractionBox: {"": "Object;center<,depth<,height<,width<",
  ...
  $eq: function(_, other) {
    ...
    if (!$.$eq(this.depth, other.get$depth()))
      return false;
    if (!$.$eq(this.height, other.get$height()))
      return false;
    if (!$.$eq(this.width, other.get$width()))
      return false;
    return true;
  },
  get$hashCode: function(_) {
...
KeyTapGesture: {"": "Gesture;direction<,pointable,position,progress,duration,durationSeconds,frame,hands,id,pointables,state,type", $isKeyTapGesture: true},

LeapEvent: {"": "Object;_type,_liblib2$_target,frame<",
  LeapEvent$3$frameObject$targetListener$type: function(frameObject, targetListener, type) {
    this._type = type;
    this._liblib2$_target = targetListener;
...
Matrix: {"": "Object;origin>,xBasis<,yBasis<,zBasis<",
  transformPoint$1: function(inVector) {
    return $.Vector3$($.$mul$n(this.xBasis, inVector.get$x()).get$x(), $.$mul$n(this.yBasis, inVector.get$y()).get$y(), $.$add$ns($.$mul$n(this.zBasis, inVector.get$z()).get$z(), this.origin.get$z()));
  },
  transformDirection$1: function(inVector) {
    var x, y, z;
    x = $.$mul$n(this.xBasis, inVector.get$x());
    y = $.$mul$n(this.yBasis, inVector.get$y());
    z = $.$mul$n(this.zBasis, inVector.get$z());
    return $.$add$ns($.$add$ns(x, y), z);
  },
  $mul: function(_, other) {
    var x, y, z, o;
    x = this.transformDirection$1(other.get$xBasis());
    y = this.transformDirection$1(other.get$yBasis());
    z = this.transformDirection$1(other.get$zBasis());
    o = this.origin;
    return $.Matrix$(o === true && $.get$origin$x(other) === true ? this.transformPoint$1($.get$origin$x(other)) : o, x, y, z);
  },
  $eq: function(_, other) {
    if (other == null)
      return false;
...
Pointable: {"": "Object;direction<,frame<,hand<,id<,length>,width<,tipPosition<,stabilizedTipPosition,timeVisible,tipVelocity<,isFinger<,isTool<,touchZone,touchDistance",
  ...
  $eq: function(_, other) {
    ...
    if (!t1.$eq(t1, other.get$direction()))
      return false;
    if (!$.$eq(this.length, $.get$length$asx(other)))
      return false;
    if (!$.$eq(this.width, other.get$width()))
      return false;
    if (!$.$eq(this.id, other.get$id()))
  ...
  toString$0: function(_) {
    var t1, t2;
    t1 = this.direction;
    t1 = $.JSString_methods.$add($.JSString_methods.$add("[Pointable direction: ", $.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("[Vector3 x:", $.toString$0(t1.x)), " y:"), $.toString$0(t1.y)), " z:"), $.toString$0(t1.z)), "]")), " tipPosition: ");
    t2 = this.tipPosition;
    t2 = $.JSString_methods.$add($.JSString_methods.$add(t1, $.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("[Vector3 x:", $.toString$0(t2.x)), " y:"), $.toString$0(t2.y)), " z:"), $.toString$0(t2.z)), "]")), " tipVelocity: ");
    t1 = this.tipVelocity;
    return $.JSString_methods.$add($.JSString_methods.$add(t2, $.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("[Vector3 x:", $.toString$0(t1.x)), " y:"), $.toString$0(t1.y)), " z:"), $.toString$0(t1.z)), "]")), "]");
  },
...
ScreenTapGesture: {"": "Gesture;direction<,pointable,position,progress,duration,durationSeconds,frame,hands,id,pointables,state,type", $isScreenTapGesture: true},

SwipeGesture: {"": "Gesture;direction<,pointable,position,speed,startPosition,duration,durationSeconds,frame,hands,id,pointables,state,type", $isSwipeGesture: true},
...
Vector3: {"": "Object;x<,y<,z<",
  $add: function(_, other) {
    ...
    t2 = other.get$x();
    if (typeof t2 !== "number")
      return this.$$add$bailout(2, other, t1, t2);
    t2 = t1 + t2;
    t1 = this.y;
    if (typeof t1 !== "number")
      return this.$$add$bailout(3, other, t1, t2);
    t3 = other.get$y();
    if (typeof t3 !== "number")
      return this.$$add$bailout(4, other, t1, t2, t3);
    t3 = t1 + t3;
    t1 = this.z;
    if (typeof t1 !== "number")
      return this.$$add$bailout(5, other, t1, t2, t3);
    t4 = other.get$z();
    if (typeof t4 !== "number")
      return this.$$add$bailout(6, 0, t1, t2, t3, t4);
    return new $.Vector3(t2, t3, t1 + t4);
  },
  $$add$bailout: function(state0, other, t1, t2, t3, t4) {
    switch (state0) {
      ...
      case 6:
        state0 = 0;
        return new $.Vector3(t2, t3, $.$add$ns(t1, t4));
    }
  },
  $sub: function(_, other) {
    ...
    t2 = other.get$x();
    if (typeof t2 !== "number")
      return this.$$sub$bailout(2, other, t1, t2);
    t2 = t1 - t2;
    t1 = this.y;
    if (typeof t1 !== "number")
      return this.$$sub$bailout(3, other, t1, t2);
    t3 = other.get$y();
    if (typeof t3 !== "number")
      return this.$$sub$bailout(4, other, t1, t2, t3);
    t3 = t1 - t3;
    t1 = this.z;
    if (typeof t1 !== "number")
      return this.$$sub$bailout(5, other, t1, t2, t3);
    t4 = other.get$z();
    if (typeof t4 !== "number")
  ...
  $$sub$bailout: function(state0, other, t1, t2, t3, t4) {
    switch (state0) {
      ...
      case 6:
        state0 = 0;
        return new $.Vector3(t2, t3, $.$sub$n(t1, t4));
    }
  },
  $mul: function(_, scalar) {
    var t1, t2, t3;
    if (typeof scalar !== "number")
      return this.$$mul$bailout(1, scalar);
    t1 = this.x;
    if (typeof t1 !== "number")
      return this.$$mul$bailout(2, scalar, t1);
    t1 *= scalar;
    t2 = this.y;
    if (typeof t2 !== "number")
      return this.$$mul$bailout(3, scalar, t1, t2);
    t2 *= scalar;
    t3 = this.z;
    if (typeof t3 !== "number")
      return this.$$mul$bailout(4, scalar, t1, t2, t3);
    return new $.Vector3(t1, t2, t3 * scalar);
  },
  $$mul$bailout: function(state0, scalar, t1, t2, t3) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
      ...
      case 4:
        state0 = 0;
        return new $.Vector3(t1, t2, $.$mul$n(t3, scalar));
    }
  },
  $div: function(_, scalar) {
    ...
    t1 = this.x;
    if (typeof t1 !== "number")
      return this.$$div$bailout(1, scalar, t1);
    t1 /= scalar;
    t2 = this.y;
    if (typeof t2 !== "number")
      return this.$$div$bailout(2, scalar, t1, t2);
    t2 /= scalar;
    t3 = this.z;
    if (typeof t3 !== "number")
      return this.$$div$bailout(3, scalar, t1, t2, t3);
    return new $.Vector3(t1, t2, t3 / scalar);
  },
  ...
  $eq: function(_, other) {
    if (other == null)
      return false;
    return !$.$eq(this.x, other.get$x()) || !$.$eq(this.y, other.get$y()) || !$.$eq(this.z, other.get$z());
  },
  angleTo$1: function(other) {
    var t1, t2, t3, t4, t5, t6, t7, t8, denom;
    t1 = this.x;
    if (typeof t1 !== "number")
      return this.angleTo$1$bailout(1, other, t1);
    t2 = t1 * t1;
    t3 = this.y;
    if (typeof t3 !== "number")
      return this.angleTo$1$bailout(2, other, t1, t3, t2, $.JSNumber_methods);
    t2 += t3 * t3;
    t4 = this.z;
    if (typeof t4 !== "number")
      return this.angleTo$1$bailout(3, other, t1, t3, t2, $.JSNumber_methods, $.JSNumber_methods, t4);
    t2 += t4 * t4;
    other.magnitudeSquared$0;
    t5 = other.x;
    if (typeof t5 !== "number")
      return this.angleTo$1$bailout(4, other, t1, t3, t2, $.JSNumber_methods, $.JSNumber_methods, t4, $.JSNumber_methods, t5);
    t6 = t5 * t5;
    t7 = other.y;
    if (typeof t7 !== "number")
      return this.angleTo$1$bailout(5, other, t1, t3, t2, $.JSNumber_methods, $.JSNumber_methods, t4, $.JSNumber_methods, t5, t6, t7);
    t6 += t7 * t7;
    t8 = other.z;
    if (typeof t8 !== "number")
      return this.angleTo$1$bailout(6, 0, t1, t3, t2, $.JSNumber_methods, $.JSNumber_methods, t4, $.JSNumber_methods, t5, t6, t7, t8);
    denom = t2 * (t6 + t8 * t8);
    if (denom <= 0)
      return 0;
    return Math.acos($.checkNum((t1 * t5 + t3 * t7 + t4 * t8) / Math.sqrt($.checkNum(denom))));
  },
  angleTo$1$bailout: function(state0, other, t1, t4, t3, t2, t5, t6, t7, t8, t9, t10, t11) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
      ...
      case 2:
        ...
        t3 = $.$add$ns(t3, t5.$mul(t4, t4));
        t6 = this.z;
      case 3:
        state0 = 0;
        t7 = $.getInterceptor$n(t6);
        t3 = $.$add$ns(t3, t7.$mul(t6, t6));
        other.magnitudeSquared$0;
        t8 = other.x;
      case 4:
        state0 = 0;
      ...
      case 5:
        state0 = 0;
        t9 = $.$add$ns(t9, $.$mul$n(t10, t10));
        t11 = other.z;
      case 6:
        var denom;
        state0 = 0;
        denom = $.$mul$n(t3, $.$add$ns(t9, $.$mul$n(t11, t11)));
        if ($.$le$n(denom, 0))
          return 0;
        return Math.acos($.checkNum($.$div$n($.$add$ns($.$add$ns(t2.$mul(t1, t8), t5.$mul(t4, t10)), t7.$mul(t6, t11)), Math.sqrt($.checkNum(denom)))));
    }
  },
  isValid$0: function() {
    var t1, t2;
...
ListenerObject$: function(typeStr, listenerFunction) {
  var t1 = new $.ListenerObject(null, null);
  t1.ListenerObject$2(typeStr, listenerFunction);
  return t1;
},
...
Gesture$: function() {
  var t1, t2;
  t1 = $.List_List(null, $.Hand);
  $.setRuntimeTypeInfo(t1, [$.Hand]);
  t2 = $.List_List(null, $.Pointable);
  $.setRuntimeTypeInfo(t2, [$.Pointable]);
  return new $.Gesture(null, null, null, t1, null, t2, null, null);
},

Gesture_invalid: function() {
  return $.Gesture$();
},
...
LeapUtil_toDegrees: function(radians) {
  if (typeof radians !== "number")
    return $.LeapUtil_toDegrees$bailout(1, radians);
  return radians * 180 / 3.141592653589793;
},

LeapUtil_toDegrees$bailout: function(state0, radians) {
  return $.$div$n($.$mul$n(radians, 180), 3.141592653589793);
},
...
Sample: {"": "Object;controller",
  ...
  get$onConnected: function() {
    return new $.BoundClosure$1(this, "onConnected$1", null);
  },
  onFrame$1: function($event) {
    var frame, t1, hand, fingers, avgPos, i, normal, direction, gestures, gesture, clockwiseness, previousGesture, sweptAngle;
    frame = $event.get$frame();
    $.print($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Frame id:", $.toString$0(frame.get$id())), ", timestamp:"), $.toString$0(frame.get$timestamp())), ", hands:"), $.JSInt_methods.toString$0(frame.get$hands().length)), ", fingers:"), $.JSInt_methods.toString$0(frame.get$fingers().length)), ", tools:"), $.JSInt_methods.toString$0(frame.get$tools().length)), ", gestures:"), $.JSInt_methods.toString$0(frame.gestures$0().length)));
    if (frame.get$hands().length > 0) {
      t1 = frame.get$hands();
      if (0 >= t1.length)
        throw $.ioore(0);
      hand = t1[0];
      fingers = hand.get$fingersVector();
      if (fingers.length > 0) {
        avgPos = $.Vector3_zero();
        for (i = 0; t1 = fingers.length, i < t1; ++i) {
          t1 = fingers[i].get$tipPosition();
          avgPos = new $.Vector3($.$add$ns(avgPos.x, t1.x), $.$add$ns(avgPos.y, t1.y), $.$add$ns(avgPos.z, t1.z));
        }
        avgPos = avgPos.$div(avgPos, $.JSInt_methods.toDouble$0(t1));
        $.print($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Hand has ", $.JSInt_methods.toString$0(fingers.length)), " fingers, average finger tip position:"), avgPos.toString$0(avgPos)));
      }
      $.print($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Hand sphere radius:", $.toString$0(hand.get$sphereRadius())), " mm, palm position:"), $.toString$0(hand.get$palmPosition())));
      normal = hand.get$palmNormal();
      direction = hand.get$direction();
      $.print($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Hand pitch:", $.toString$0($.LeapUtil_toDegrees(direction.get$pitch()))), " degrees, "), "roll:"), $.toString$0($.LeapUtil_toDegrees(normal.get$roll()))), " degrees, "), "yaw:"), $.toString$0($.LeapUtil_toDegrees(direction.get$yaw()))), " degrees\n"));
    }
    gestures = frame.gestures$0();
    for (i = 0; i < gestures.length; ++i) {
      gesture = gestures[i];
      switch ($.get$type$x(gesture)) {
        case 6:
          $.propertyTypeCast(gesture, "$isCircleGesture");
          clockwiseness = gesture.pointable.get$direction().angleTo$1(gesture.normal) <= 0.7853981633974483 ? "clockwise" : "counterclockwise";
          if (gesture.state !== 1) {
            previousGesture = this.controller.frame$1$history(1).gesture$1(gesture.id);
            sweptAngle = previousGesture.isValid$0() ? $.$mul$n($.$mul$n($.$sub$n(gesture.progress, $.propertyTypeCast(previousGesture, "$isCircleGesture").progress), 2), 3.141592653589793) : 0;
          } else
            sweptAngle = 0;
          $.Primitives_printString($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Circle id:", $.toString$0(gesture.id)), ", "), $.toString$0(gesture.state)), ", progress:"), $.toString$0(gesture.progress)), ", radius:"), $.toString$0(gesture.radius)), ", angle:"), $.toString$0($.$div$n($.$mul$n(sweptAngle, 180), 3.141592653589793))), ", "), clockwiseness));
          break;
        case 5:
          $.propertyTypeCast(gesture, "$isSwipeGesture");
          $.Primitives_printString($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Swipe id:", $.toString$0(gesture.id)), ", "), $.toString$0(gesture.state)), ", position:"), $.toString$0(gesture.position)), ", direction:"), $.toString$0(gesture.direction)), ", speed:"), $.toString$0(gesture.speed)));
          break;
        case 7:
          $.propertyTypeCast(gesture, "$isScreenTapGesture");
          $.Primitives_printString($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Screen Tap id:", $.toString$0(gesture.id)), ", "), $.toString$0(gesture.state)), ", position:"), $.toString$0(gesture.position)), ", direction:"), $.toString$0(gesture.direction)));
          break;
        case 8:
          $.propertyTypeCast(gesture, "$isKeyTapGesture");
          $.Primitives_printString($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("Key Tap id:", $.toString$0(gesture.id)), ", "), $.toString$0(gesture.state)), ", position:"), $.toString$0(gesture.position)), ", direction:"), $.toString$0(gesture.direction)));
          break;
      }
    }
  },
  get$onFrame: function() {
    return new $.BoundClosure$1(this, "onFrame$1", null);
  },
  Sample$0: function() {
    this.controller = $.Controller$(null);
    this.controller.addEventListener$2($.LeapEvent_LEAPMOTION_CONNECTED, this.get$onConnected());
    this.controller.addEventListener$2($.LeapEvent_LEAPMOTION_FRAME, this.get$onFrame());
  }
},

Sample$: function() {
  var t1 = new $.Sample(null);
  t1.Sample$0();
  return t1;
},
...
ReceivePortImpl: {"": "Object;_id<,_liblib3$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $._globalState().currentContext.register$2(this._id, this);
  }
},
...
ListMixin: {"": "Object;",
  ...
  toString$0: function(receiver) {
    ...
    result0.StringBuffer$1("");
    result = result0;
    try {
      $.get$ListMixin__toStringList().push(receiver);
      t1 = result;
      t1.set$_contents($.Primitives_stringConcatUnchecked(t1.get$_contents(), "["));
...
NoSuchMethodError: {"": "Error_StackTraceOnThrow1;_liblib0$_receiver,_memberName,_arguments,_namedArguments,_existingArgumentNames",
  toString$0: function(_) {
    var t1, sb, t2, t3, t4;
    t1 = {};
    sb = new $.StringBuffer("");
    ...
    while (true) {
      ...
      t3 = t1.i_1;
      if (typeof t3 !== "number")
        return this.toString$0$bailout1(2, t1, t2, t3);
      t1.i_1 = t3 + 1;
    }
